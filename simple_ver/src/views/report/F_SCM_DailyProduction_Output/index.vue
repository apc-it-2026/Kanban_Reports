<template>
  <div class="container">
    ...
    <a-card
      class="general-card"
      :title="$t('menu.list.DailyProduction_Output')"
    >
      <a-row>
        <a-col :flex="1">
          <a-form
          ...
          >
            <a-row :gutter="16">
              <a-col :span="8">
                ...
                >
                  <a-input
                    ...
                    :placeholder="
                      $t('DailyProduction_Output.form.se_id.placeholder')
                    "
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item
                  field="name"
                  :label="$t('DailyProduction_Output.form.order_no')"
                >
                  <a-input
                    v-model="formModel.order_no"
                    :placeholder="
                      $t('DailyProduction_Output.form.order_no.placeholder')
                    "
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item
                  field="name"
                  :label="$t('DailyProduction_Output.form.art')"
                >
                  <a-input
                    v-model="formModel.art"
                    :placeholder="
                      $t('DailyProduction_Output.form.art.placeholder')
                    "
                  />
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item
                  field="name"
                  :label="$t('DailyProduction_Output.form.company')"
                >
                  <a-input
                    v-model="formModel.company"
                    :placeholder="
                      $t('DailyProduction_Output.form.company.placeholder')
                    "
                  />
                </a-form-item>
              </a-col>
      ...
      <a-row style="margin-bottom: 16px">
        ...
        >
          ...
          <a-tooltip
            :content="$t('DailyProduction_Output.actions.columnSetting')"
          >
            <a-popover
              trigger="click"
              position="bl"
      ...
      >
        ...
        <template #contentType="{ record }">
          <a-space>
            ...
            {{
              $t(
                `DailyProduction_Output.form.contentType.${record.contentType}`
              )
            }}
          </a-space>
        </template>
